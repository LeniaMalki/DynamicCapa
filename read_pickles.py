...
# Function to calculate the percentage rounded to a specific decimal place
def get_perc_round(tot: int, part: int, round_n: int = 1) -> float:
    return round(part * 100 / tot, round_n)

# Function to calculate statistics (min, max, median, mean, and standard deviation) of a list of data
...
# Function to calculate the percentage of each item in a list based on its frequency
...
# Function to write and flush content to a file
